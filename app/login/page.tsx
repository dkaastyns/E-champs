        ...
        <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-lg p-8">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <Field>
              ...
              <Input
                ...
                className="bg-[#080808] border-[#1a1a1a] text-white placeholder:text-gray-600 focus:border-[#6520EE] focus:ring-[#6520EE]"
                {...form.register('email')}
              />
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#6520EE] hover:bg-[#7c3aed] text-white font-bold py-3 h-auto"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/register" className="text-[#2BE900] hover:underline">
                Register
              </Link>
            </p>
          </div>
