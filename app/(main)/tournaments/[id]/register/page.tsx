	...
	return (
		<div className="max-w-2xl">
			...
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
				<Field>
					<FieldLabel htmlFor="teamName" className="text-white">
						TEAM NAME
					</FieldLabel>
					<Input
						id="teamName"
				...
				<div className="grid grid-cols-2 gap-4">
					<Field>
						<FieldLabel htmlFor="contactEmail" className="text-white">
							CONTACT EMAIL
						</FieldLabel>
						<Input
							id="contactEmail"
					...
					<Field>
						<FieldLabel htmlFor="contactPhone" className="text-white">
							CONTACT PHONE
						</FieldLabel>
						<Input
							id="contactPhone"
